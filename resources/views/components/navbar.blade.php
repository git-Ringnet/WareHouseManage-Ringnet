            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <span class="dropdown-item dropdown-header">{{count($message)}} Thông báo</span>
                        <div class="dropdown-divider"></div>
                        <div class="p-2 text-right text-sm hover-read-at" id="read_status">
                            Đánh dấu tất cả đã đọc
                        </div>
                        @foreach ($message as $value)
                            <div class="dropdown-divider"></div>
                            <div class="d-flex position-relative">
                                <a href="{{ route('exports.edit', $value->id) }}" class="dropdown-item">
                                    {{ $value->message }}
                                </a>
                                <i class="fa-solid fa-trash trash-read text-danger"></i>
                            </div>
                        @endforeach
                    </div>
                </li>
