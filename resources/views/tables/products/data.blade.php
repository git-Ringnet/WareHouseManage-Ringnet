            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <tr class="{{$value->id}}">
                                        ...
                                        <td>
                                            <select class="product_category" name="product_category" id="{{ $value->id }}">
                                                ...
                                                <option value="{{ $va->id }}" {{ $va->id == $value->ID_category ? 'selected' : '' }}>
                                                    {{ $va->category_name }}
                                                </option>
                                                @endforeach
                                            </select>
                        ...
                        <button type="submit" id="deleteProducts" class="btn btn-danger mt-3" onclick="return confirm('Bạn có muốn xóa các sản phẩm đã chọn ?');">Xóa nhiều</button>
