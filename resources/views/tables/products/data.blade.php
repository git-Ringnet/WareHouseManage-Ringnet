        ...
        <section class="content-header">
            <div class="container-fluided">
                <div class="row items_action">
                    ...
                    <button type="button" class="btn btn-outline-primary ml-3 d-flex align-items-center">
                    ...
                    <button type="button" class="btn btn-outline-primary ml-3 d-flex align-items-center">
                        <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M8.99972 15.7998H7.49986C7.10207 15.7998 6.72058 15.6418 6.4393 15.3605C6.15802 15.0792 6 14.6977 6 14.3L6 6.49978C6 6.102 6.15802 5.7205 6.4393 5.43922C6.72058 5.15794 7.10207 4.99991 7.49986 4.99991L16.5001 4.99991C16.8979 4.99991 17.2794 5.15794 17.5607 5.43922C17.842 5.7205 18 6.102 18 6.49978V14.3C18 14.6977 17.842 15.0792 17.5607 15.3605C17.2794 15.6418 16.8979 15.7998 16.5001 15.7998H15.0003" stroke="#0095F6" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.0002 12.2007L12.0005 9.20098L8.99969 12.2007" stroke="#0095F6" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M11.9994 20.6003L11.9994 9.80045" stroke="#0095F6" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                ...
                <div class="row m-auto filter">
                    <form class="w-100" action="" method="get" id='search-filter'>
                        <div class="row mr-0">
                            ...
                            <a class="btn ml-auto btn-delete-filter" href="{{ route('data.index') }}"><span><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="filter-options">
                                ...
                                <div class="block-options" id="status-options" style="display:none">
                                    <div class="wrap w-100">
                                        ...
                                        <div class="search-container px-2 mt-1">
                                            <input type="text" placeholder="Tìm thuộc tính lọc" id="myInput-status" class="pr-4 w-100 input-search" onkeyup="filterStatus()">
                                            <span class="search-icon"><i class="fas fa-search"></i></span>
                                        </div>
                                ...
                                <div class="block-options" id="category-options" style="display:none">
                                    <div class="wrap w-100">
                                        ...
                                        <div class="search-container px-2 mt-1">
                                            <input type="text" placeholder="Tìm thuộc tính lọc" id="myInput-category" class="pr-4 w-100" onkeyup="filterCategory()">
                                            <span class="search-icon"><i class="fas fa-search"></i></span>
                                        </div>
                                        <div class="select-checkbox d-flex justify-contents-center align-items-baseline pb-2 px-2">
                                        ...
                                        <div class="d-flex justify-contents-center align-items-baseline px-2">
                                            <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                                Nhận</button>
                                            <button type="button" id="cancel-category" class="btn btn-secondary btn-block">Hủy</button>
                                        </div>
                                    </div>
                                </div>
                                {{-- filter thương hiệu --}}
                                <div class="block-options" id="trademark-options" style="display:none">
                                    <div class="wrap w-100">
                                        ...
                                        <div class="search-container px-2 mt-1">
                                            <input type="text" placeholder="Tìm thuộc tính lọc" id="myInput-trademark" class="pr-4 w-100" onkeyup="filterTrademark()">
                                            <span class="search-icon"><i class="fas fa-search"></i></span>
                                        </div>
                                        <div class="select-checkbox d-flex justify-contents-center align-items-baseline pb-2 px-2">
                                        ...
                                        <div class="d-flex justify-contents-center align-items-baseline px-2">
                                            <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                                Nhận</button>
                                            <button type="button" id="cancel-trademark" class="btn btn-secondary btn-block">Hủy</button>
                                        </div>
                                    </div>
                                </div>
                                {{-- filter tồn kho --}}
                                <div class="block-options" id="quantity-options" style="display:none">
                                    <div class="wrap w-100">
                                        ...
                                        <div class="input-group pt-2 justify-content-around">
                                            ...
                                            <input class="w-50 quantity-input" type="number" name="quantity" value="{{ request()->quantity }}" placeholder="Số lượng">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-contents-center align-items-baseline px-2">
                                        <button type="submit" class="btn btn-primary btn-block mr-2">Xác Nhận</button>
            ...
            <section class="multiple_action">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9 d-flex">
                        ...
                        <button class="btn btn-light ml-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6C12.3879 6 12.7024 6.31446 12.7024 6.70237L12.7024 17.2976C12.7024 17.6855 12.3879 18 12 18C11.6121 18 11.2976 17.6855 11.2976 17.2976V6.70237C11.2976 6.31446 11.6121 6 12 6Z" fill="#555555" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M18 12C18 12.3879 17.6855 12.7024 17.2976 12.7024H6.70237C6.31446 12.7024 6 12.3879 6 12C6 11.6121 6.31446 11.2976 6.70237 11.2976H17.2976C17.6855 11.2976 18 11.6121 18 12Z" fill="#555555" />
                            </svg>
...
<script>
    ...
    // Hàm xử lý hiển thị multiple action
