...
@endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" id="product_name" <?php if (!Auth::user()->can('view-provides')) echo 'readonly' ?> name="product_name" value="{{ $pro->product_name }}">
                                </div>
                                <div class="form-group">
                                    <label for="email">Loại hàng</label>
                                    <input required type="text" class="form-control" id="product_type" <?php if (!Auth::user()->can('view-provides')) echo 'readonly' ?> name="product_type" value="{{ $pro->product_category }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Đơn vị tính</label>
                                    <input required type="text" class="form-control" id="product_unit" <?php if (!Auth::user()->can('view-provides')) echo 'readonly' ?> name="product_unit" value="{{ $pro->product_unit }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="email">Ghi chú</label>
                                    <input type="text" class="form-control" id="product_trademark" <?php if (!Auth::user()->can('view-provides')) echo 'readonly' ?> name="product_trademark" value="{{ $pro->product_trademark }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" class="form-control" id="product_price" <?php if (!Auth::user()->can('view-provides')) echo 'readonly' ?> name="product_price" value="{{ number_format($pro->product_price) }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Thuế</label>
                                    <input type="text" class="form-control" readonly id="product_tax" name="product_tax" value="{{ $pro->tax }}%">
                                </div>
                                <div class="form-group">
                                </div>
                            </div>
