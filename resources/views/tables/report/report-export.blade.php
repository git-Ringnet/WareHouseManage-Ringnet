                    ...
                    <div class="col-md-3">
                        <div class="bg-white rounded">
                            <div class="d-flex p-2">
                                <div class="rounded p-2 background-purple-light">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                        ...
                                        <g clip-path="url(#clip0_7866_242716)">
                                            ...
                                            <path d="M29.1667 23.0293V28.3326" stroke="#556aeb" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                            ...
                                            <path
                                                ...
                                                stroke="#556aeb" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path d="M15.4167 18.334H21.6667" stroke="#556aeb" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M15.4167 11.875H26.6667" stroke="#556aeb" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round" />
                                            <path
                                ...
                                <div class="ml-2">
                                    <p class="m-0">Tổng đơn xuất</p><b class="m-0">{{ $exports }}</b>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="bg-white rounded">
                            <div class="d-flex p-2">
                                ...
                                <div class="ml-2">
                                    <p class="m-0">Tổng lợi nhuận</p><b class="m-0">{{ $formattedLoinhuan }}</b>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="filter-options">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" id="dropdown-menu"
                                            ...
                                            {{-- <button class="dropdown-item" id="btn-sum-export">Tổng đơn xuất</button>
                                            <button class="dropdown-item" id="btn-sum-sale">Tổng tiền bán</button>
                                            <button class="dropdown-item" id="btn-sum-difference">Tổng lợi
                                                nhuận</button>
                                            <button class="dropdown-item" id="btn-sum_debt">Tổng công
                                                nợ</button> --}}
                                        </div>
                                        @if (!empty($string))
                                            <a class="btn-delete-filter" href="{{ route('indexExport') }}"><span>Tắt
                                                    bộ
                                                    lọc</span></a>
                                        @endif
                                    </div>
                                    ...
                                    // Công nợ
                                    $sum_debt_operator = null;
                                    $sum = null;
                                    if (isset(request()->sum_debt_operator) && isset(request()->sum_sum_debt)) {
                                        $sum_debt_operator = request()->sum_debt_operator;
                                        $sum = request()->sum_sum_debt;
                                    } else {
                                        $sum_debt_operator = null;
                                        $sum = null;
                                    }
                                    ...
                                    {{-- Tổng đơn xuất --}}
                                    <div class="block-options" id="export-options" style="display:none">
                                        <div class="wrap w-100">
                                            <div class="heading-title title-wrap">
                                                <h5>Tổng đơn xuất</h5>
                                            </div>
                                    ...
                                    {{-- Tổng công nợ --}}
                                    <div class="block-options" id="sum_debt-options" style="display:none">
                                        <div class="wrap w-100">
                                            <div class="heading-title title-wrap">
                                                <h5>Tổng công nợ</h5>
                                            </div>
                                            <div class="input-group p-2 justify-content-around">
                                                <select class="sum_debt_operator input-so"
                                                    name="sum_debt_operator" style="width: 40%">
                                                    <option value=">="
                                                ...
                                                <input class="w-50 input-quantity sum_debt-input" type="text"
                                                    oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                                                    name="sum_debt" value="{{ request()->sum_debt }}"
                                                    placeholder="Tổng công nợ">
                                            </div>
                                        </div>
                                        <div class="d-flex justify-contents-center align-items-baseline p-2">
                                            <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                                Nhận</button>
                                            <button type="button" id="cancel-sum_debt"
                                                class="btn btn-default btn-block">Hủy</button>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    // Xuất
    $('#btn-sum-export').click(function(event) {
        event.preventDefault();
        $('.btn-filter').prop('disabled', true);
    ...
    // Công nợ
    $('#btn-sum_debt').click(function(event) {
        event.preventDefault();
        $('.btn-filter').prop('disabled', true);
        $('#sum_debt-options').toggle();
    });
    $('#cancel-sum_debt').click(function(event) {
        event.preventDefault();
        $('.btn-filter').prop('disabled', false);
        $('.sum_debt-input').val('');
        $('#sum_debt-options').hide();
    });
    ...
    // Nhập
    $(document).ready(function() {
        $('.filter-results').on('click', '.delete-btn-sum-export', function() {
            $('.export-input').val('');
            document.getElementById('search-filter').submit();
        });
    });
    ...
    // Công nợ
    $(document).ready(function() {
        $('.filter-results').on('click', '.delete-btn-sum_debt', function() {
            $('.sum_debt-input').val('');
            document.getElementById('search-filter').submit();
        });
    });
