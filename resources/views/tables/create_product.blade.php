              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <button id="addNew_SN">Thêm SN</button>
                  </div>
...
<script>
  ...
  var addNew_SN = document.getElementById('addNew_SN');
  if (addNew_SN) {
    addNew_SN.addEventListener('click', function(e) {
      e.preventDefault();
  ...
  if (add_products) {
    add_products.addEventListener('click', function(e) {
      ...
      snCell.innerHTML = ' <button name="btn_add_SN[]" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> SN </button>';
