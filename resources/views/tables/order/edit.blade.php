                ...
                <table class="table table-hover bg-white rounded" id="inputContainer">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <input class="form-control text-center" style="width: 120px" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="text"
                            ...
                            <td> <input class="form-control text-center" style="width: 80px" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="text"
                            ...
                            <td> <input class="form-control text-center" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="number"
                                ...
                                @if (Auth::user()->id != $order->users_id && Auth::user()->roleid != 1) <?php echo 'readonly'; ?> @endif> </td>
                            <td>
                                <select name="product_tax[]" id="" class="form-control product_tax" style="width:80px;" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) disabled @endif>>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="form-control w-25" name="product_SN{{ $stt }}[]" value="{{ $se->serinumber }}" onpaste="handlePaste(this)" <?php if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && Auth::user()->roleid != 1)) {
                                                                                                                                                                                                echo 'readonly';
                                                                                                                                                                                            } ?>>
                                                </td>
                                                @if ($order->order_status == 0)
