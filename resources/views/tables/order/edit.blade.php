        ...
        <div class="row p-3">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" id="provide_represent"
                        placeholder="Nhập thông tin" name="provide_represent"
                        value="{{ $provide_order[0]->provide_represent }}">
                </div>
                <div class="form-group">
                    <label for="email">Email:</label>
                    <input required type="email" class="form-control" id="provide_email"
                        placeholder="Nhập thông tin" name="provide_email"
                        value="{{ $provide_order[0]->provide_email }}">
                </div>
                <div class="form-group">
                    <label for="email">Số điện thoại:</label>
                    <input required type="text" class="form-control" id="provide_phone"
                ...
                <tbody>
                    ...
                    @foreach ($product_order as $pro)
                        <tr>
                            ...
                            <td> <input readonly type="text" name='products_id[]' value="{{ $pro->products_id }}"
                                    placeholder="{{ $pro->getCodeProduct->products_code }}"></td>
                            <td> <input required type="text" name="product_name[]"
                                    value="{{ $pro->product_name }}"> </td>
                            <td> <input required type="text" name="product_category[]"
                                    value="{{ $pro->product_category }}"> </td>
                            <td> <input required type="text" name="product_unit[]"
                                    value="{{ $pro->product_unit }}"> </td>
                            <td> <input required type="number" name="product_qty[]" value="{{ $pro->product_qty }}"
                                    class="quantity-input"> </td>
                            <td> <input required type="number" name="product_price[]"
                                    value="{{ $pro->product_price }}"> </td>
                            <td> <input required type="number" name="product_tax[]" value="{{ $pro->product_tax }}"
                                    ...
                                    @foreach ($seri as $se)
                                        @if ($pro->id == $se->product_id)
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <td style="width:5%;"><input type="checkbox" class="mr-5">
                                                        </td>
                                                        <td style="width:5%;"><span class="mr-5">STT</span></td>
                                                        <td><span class="mr-5">Serial Number</span></td>
                                                        <td style="width:3%;"></td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td><input class="mr-5" type="checkbox"
                                                                id="checkbox_{{ $stt }}"></td>
...
<script>
    ...
    for (let k = 0; k < info.length; k++) {
        info[k].addEventListener('click', function() {
            var productCode = $(this).closest('tr').find('[name^="products_id"]').attr('placeholder');
            var productName = $(this).closest('tr').find('[name^="product_name"]').val();
            var productType = $(this).closest('tr').find('[name^="product_category"]').val();
            var productQty = $(this).closest('tr').find('[name^="product_qty"]').val();
            $('.code_product').text(productCode);
