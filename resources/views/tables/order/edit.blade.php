            ...
            <div class="row p-3">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif id="provide_name"
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif id="provide_address"
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif id="provide_represent"
                    ...
                    <div class="form-group">
                        ...
                        <input required type="email" class="form-control" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif id="provide_email"
                ...
                <table class="table table-hover bg-white rounded" id="inputContainer">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <input class="form-control name_product" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif
                            ...
                            <td> <input class="form-control text-center type_product" style="width: 120px" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="text"
                            ...
                            <td> <input class="form-control text-center unit_product" style="width: 80px" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="text"
                                name="product_unit[]" value="{{ $pro->product_unit }}"
                                @if (Auth::user()->id != $order->users_id && Auth::user()->roleid != 1) <?php echo 'readonly'; ?> @endif> </td>
                            <td> <input oninput="validatQtyInput(this)" class="form-control quantity-input text-center" oninput="validateNumberInput(this)" @if ($order->order_status != 0 || (Auth::user()->id != $order->users_id && !Auth::user()->can('isAdmin'))) readonly @endif required type="text"
...
<script>
    ...
    $(document).on('click', '.addBillEdit', function(e) {
        ...
        if ($('#form_submit')[0].checkValidity()) {
            ...
            for (var i = 0; i < listSNOld.length - 1; i++) {
                for (var j = i + 1; j < listSNOld.length; j++) {
                    if (listSNOld[i].trim() === listSNOld[j].trim()) {
                        isDuplicate = true;
                        alert("Đã nhập trùng serial number " + " " + listSNOld[j]);
                        break;
                    }
                }
                if (isDuplicate) {
            ...
            // for (var i = 0; i < listSNOld.length; i++) {
            ...
            var hasErrors = isDuplicate || listSNOld.length != countQTY || checkRow() === false || checkDuplicateRows() === true || er === true;
    ...
    $('.addRow').on('click', function() {
        ...
        var tr = '<tr>' +
            ...
            '</td>' +
            '<td><input required type="text" class="form-control text-center type_product" style="width:120px" name="product_category[]"></td>' +
        ...
        var modal = '<div class="modal fade" id="exampleModal' + rowCount +
            ...
            '<td><span class="mr-5 stt_SN" >1</span></td>' +
    ...
    // Thay đổi tên theo input đã nhập
