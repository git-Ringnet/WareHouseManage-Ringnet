...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="d-flex mb-1">
            ...
            <button style="margin-left:24px" type="button" onclick="exportToExcel()" class="btn bg-transparent border-primary d-flex align-items-center">
                    ...
                    <div class="filter-options">
                        ...
                        <div class="block-options" id="provide_name-options" style="display:none">
                            <div class="wrap w-100">
                                ...
                                <div class="search-container px-2 mt-2">
                                    <input type="text" placeholder="Tìm kiếm" id="myInput-provide-name" class="pr-4 w-100 input-search" onkeyup="filterProvidename()">
                                    <span class="search-icon"><i class="fas fa-search"></i></span>
                                </div>
                            ...
                            <div class="d-flex justify-contents-center align-items-baseline p-2">
                                <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                    Nhận</button>
                                <button type="button" id="cancel-provide_name" class="btn btn-default btn-block">Hủy</button>
                            </div>
                        </div>
                        {{-- Status --}}
                        ...
                        <div class="block-options" id="creator-options" style="display:none">
                            <div class="wrap w-100">
                                ...
                                <div class="search-container px-2 mt-2">
                                    <input type="text" placeholder="Tìm kiếm" id="myInput-creator" class="pr-4 w-100 input-search" onkeyup="filterCreator()">
                                    <span class="search-icon"><i class="fas fa-search"></i></span>
                                </div>
                                <div class="select-checkbox d-flex justify-contents-center align-items-baseline pb-2 px-2">
                                ...
                                <div class="d-flex justify-contents-center align-items-baseline p-2">
                                    <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                        Nhận</button>
                                    <button type="button" id="cancel-creator" class="btn btn-default btn-block">Hủy</button>
                                </div>
                            </div>
                        </div>
                        {{-- Tổng tiền --}}
                        <div class="block-options" id="sum-options" style="display:none">
                            ...
                            <div class="d-flex justify-contents-center align-items-baseline p-2">
                                <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                    Nhận</button>
                                <button type="button" id="cancel-sum" class="btn btn-default btn-block">Hủy</button>
                            </div>
                        </div>
                        {{-- Chỉnh sửa cuối --}}
                        <div class="block-options" id="update_at-options" style="display:none">
                            ...
                            <div class="d-flex justify-contents-center align-items-baseline p-2">
                                <button type="submit" class="btn btn-primary btn-block mr-2">Xác
                                    Nhận</button>
                                <button type="button" id="cancel-update_at" class="btn btn-default btn-block">Hủy</button>
                            </div>
                        </div>
                    </div>
    </section>
        ...
        <section class="multiple_action">
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex">
                    <button id="deleteOrder" class="btn btn-light d-flex align-items-center">
                    ...
                    <button id="cancelBill" class="btn btn-light ml-4 d-flex align-items-center">
