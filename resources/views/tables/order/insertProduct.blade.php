...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class="btn">Xuất Excel</div></div>
        ...
        <div class="container-fluid">
            <div class="col-12">
                <div class="card">
                            ...
                            <tbody>
                                ...
                                @foreach ($orders as $va)
                                    ...
                                    @foreach ($product as $item)
                                        <tr id="product-details-{{ $va->id }}" class="collapse product-details">
                                            @if ($va->id == $item->id)
                                                <td></td>
                                                <td></td>
                                                <td></td>
                    ...
                    <button type="submit" name="deleteOrder" id="deleteOrder" class="btn btn-danger">Xóa
                        nhiều</button>
...
<script>
    ...
    function updateDeleteItemValue(label) {
        document.getEl
        ementById('delete-item-input').value = label;
    }
