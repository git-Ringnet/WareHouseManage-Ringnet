...
@if (Auth::check() != null)
    ...
    <script>
        ...
        $('body').on('input', '.product_price', function(event) {
            ...
            var formattedNumber = formattedValue.replace(/,/g, '');
        ...
        function calculateGrandTotal() {
            ...
            $('#total').val(formattedGrandTotal.replace(/,/g, ''));
        }
            ...
            reader.onload = function(e) {
                ...
                for (var i = 0; i < THHDVu.length; i++) {
                    ...
                    var tr = '<tr>' +
                        ...
                        '<td><input required type="text" class="form-control" style="width:70px" name="product_unit[]" value="' +
                        typeValue +
                        '"></td>' +
                        '<td><input required type="number" name="product_qty[]" class="quantity-input form-control" value="' +
                        numberssValue + '"></td>' +
                        '<td><input required type="number" class="form-control" style="width:120px" name="product_price[]" value="' +
                        price + '"></td>' +
                        '<td><input required type="number" name="product_tax[]" class="product_tax form-control" style="width:70px" value=' +
                        tax +
                        '></td>' +
                        '<td><input readonly type="text" class="form-control" name="product_total[]" value="' +
                        totalPrice + '"></td>' +
    ...
    $('.search-info').click(function() {
        ...
        // Gửi giá trị đã được xử lý và định dạng
        var productPrice = parseFloat($('.product_price').val().replace(/[^0-9.]/g, ''));
