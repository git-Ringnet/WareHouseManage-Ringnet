...
<script>
    ...
    $('.addRow').on('click', function() {
        ...
        var tr = '<tr>' +
            ...
            '</td>' +
            '<td>' +
            '<input type="text" placeholder="Nhập thông tin sản phẩm" name="product_name[]" class="search_product" onkeyup="filterFunction()"> ' +
            '<div id="dropdown-values" class="dropdown-values"><ul id="myUL1" class="myUL1 bg-white position-absolute rounded shadow" style="padding:0 10px;"> </ul>  </div>' +
            '</td>' +
            '<td><input required type="text" name="product_category[]"></td>' +
            '<td><input required type="text" name="product_unit[]"></td>' +
