    ...
    <script>
        ...
        $('.addRow').on('click', function() {
            var tr = '<tr>' +
                ...
                '</td>' +
                '<td><input placeholder="Nhập đơn vị tính" required type="text" class="form-control text-center unit_product" style="width:70px" name="product_unit[]"></td>' +
                ...
                reader.onload = function(e) {
                    ...
                    for (var i = 0; i < THHDVu.length; i++) {
                        ...
                        var tr = '<tr>' +
                            ...
                            titlesValue +
                            '"></td>' +
                            '<td><input required type="text" class="form-control text-center" style="width:70px" name="product_unit[]" value="' +
                            typeValue +
                            '"></td>' +
