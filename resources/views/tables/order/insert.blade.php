...
<div class="content-wrapper">
            ...
            <div class="w-50 position-relative" style="float: right;">
                ...
                <div class="position-absolute" style="top: 32px; z-index: 0;left: 17px">
                    <svg height="4" viewBox="0 0 364 3" fill="none" style="width: 95%"
                        ...
                        <line x1="0.999268" y1="1.50098" x2="363.001" y2="1.50098" stroke="#FFFFFF" stroke-width="2"
    ...
    <section class="content-header">
        <div class="d-flex mb-1 action-don">
            ...
            <a href="#" class="btn border border-secondary d-flex align-items-center"><svg width="24" height="24"
                ...
                <div class="col">
                    <div class="w-75">
                        ...
                        <ul id="myUL" class="bg-white position-absolute w-50 rounded shadow p-0" style="z-index: 99;">
                            ...
                            <li>
                                <a href="#" class="text-dark d-flex justify-content-between p-2 search-info"
