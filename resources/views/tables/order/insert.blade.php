...
<script>
    ...
    $("#radio2").on("click", function() {
        $('#infor_provide').html(
            ...
            '<input required type="number" class="form-control" onkeypress="validateNumberInput(event)" id="provide_code_new" placeholder="Nhập thông tin" name="provide_code_new" value="">' +
