...
class OrdersSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('orders')->insert([
            ...
            'updated_at' => now(),],
            ['id' => 4,'provide_id' => 2,'users_id'=> 2,'order_status' => 1,'total' => 400000,'created_at' => now(),
            'updated_at' => now(),],
            ['id' => 5,'provide_id' => 1,'users_id'=> 3,'order_status' => 1,'total' => 500000,'created_at' => now(),
            'updated_at' => now(),],
            ['id' => 6,'provide_id' => 1,'users_id'=> 2,'order_status' => 1,'total' => 600000,'created_at' => now(),
            'updated_at' => now(),],
            ['id' => 7,'provide_id' => 2,'users_id'=> 3,'order_status' => 1,'total' => 700000,'created_at' => now(),
            'updated_at' => now(),],
            ['id' => 8,'provide_id' => 3,'users_id'=> 3,'order_status' => 1,'total' => 800000,'created_at' => now(),
            'updated_at' => now(),],
